...
$|=1;    # autoflush
  ...
  my $refr_id     = $query->param('rid');       # referrer id
...
my ($b_1, $b_2, $b_3, $b_4); #beneficiary
my $randnum;
...
if ($random_details_1) {
  ...
  $url_1 = "http://www.grepin.com/cgi-bin/amzntrk.pl?uid=$user_id&rid=$refr_id&trknum=$trknum_1&b=$b_1&url=$result_link_1";
...
if ($random_details_2) {
  ...
  $url_2 = "http://www.grepin.com/cgi-bin/amzntrk.pl?uid=$user_id&rid=$refr_id&trknum=$trknum_2&b=$b_2&url=$result_link_2";
...
if ($random_details_3) {
  ...
  $url_3 = "http://www.grepin.com/cgi-bin/amzntrk.pl?uid=$user_id&rid=$refr_id&trknum=$trknum_3&b=$b_3&url=$result_link_3";
...
if ($random_details_4) {
  ...
  $url_4 = "http://www.grepin.com/cgi-bin/amzntrk.pl?uid=$user_id&rid=$refr_id&trknum=$trknum_4&b=$b_4&url=$result_link_4";
