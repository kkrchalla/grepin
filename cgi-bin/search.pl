...
my $SEARCH_URL        = '/cgi-bin/search.pl';
...
sub cast_template {
  ...
  my $skyscraper_url = "http://www.grepin.com/cgi-bin/amznbar.pl?query=$q&key=$key&category=$category&out=javascript&locale=$locale&page=$current_page&bcolor=$border_color&fcolor=$footer_color&type=tower&disp=$tower_disp&seq=2&aid=$assoc_id&uid=$user_id&aus=$aff_us&auk=$aff_uk&source=$source&gsrc=1";
  my $skybar_url     = "http://www.grepin.com/cgi-bin/amznbar.pl?query=$q&key=$key&category=$category&out=javascript&locale=$locale&page=$current_page&bcolor=$border_color&fcolor=$footer_color&type=bar&seq=1&aid=$assoc_id&uid=$user_id&aus=$aff_us&auk=$aff_uk&source=$source&gsrc=1";

# '<iframe src="http://www.grepin.com/cgi-bin/amznbar.pl?query=$q&key=$key&category=$category&out=&locale=$locale&page=$current_page&bcolor=$border_color&fcolor=$footer_color&disp=4&type=bar&seq=1&aid=$assoc_id&uid=$user_id&aus=$aff_us&auk=$aff_uk&source=$source&gsrc=1" width="" height="" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>';
