...
my ($xml_used_line_1, $xml_used_line_2, $xml_used_line_3, $xml_used_line_4);
my ($xml_new_line_1, $xml_new_line_2, $xml_new_line_3, $xml_new_line_4);
...
if ($random_details_1) {
  ...
  if ($xml_used_price_1) {
    $xml_used_line_1 = qq[
		<BR>
		<FONT Color="red" Size="1">Used $xml_used_price_1</FONT>
    ];
  }
  ...
  if ($xml_our_price_1) {
    $xml_new_line_1 = qq[
		<FONT Color="red" Size="1">New $xml_our_price_1</FONT>
    ];
  }
...
if ($random_details_2) {
  ...
  if ($xml_used_price_2) {
    $xml_used_line_2 = qq[
		<BR>
		<FONT Color="red" Size="1">Used $xml_used_price_2</FONT>
    ];
  }
  ...
  if ($xml_our_price_2) {
    $xml_new_line_2 = qq[
		<FONT Color="red" Size="1">New $xml_our_price_2</FONT>
    ];
  }
...
if ($random_details_3) {
  ...
  if ($xml_used_price_3) {
    $xml_used_line_3 = qq[
		<BR>
		<FONT Color="red" Size="1">Used $xml_used_price_3</FONT>
    ];
  }
  ...
  if ($xml_our_price_3) {
    $xml_new_line_3 = qq[
		<FONT Color="red" Size="1">New $xml_our_price_3</FONT>
    ];
  }
...
if ($random_details_4) {
  ...
  if ($xml_used_price_4) {
    $xml_used_line_4 = qq[
		<BR>
		<FONT Color="red" Size="1">Used $xml_used_price_4</FONT>
    ];
  }
  ...
  if ($xml_our_price_4) {
    $xml_new_line_4 = qq[
		<FONT Color="red" Size="1">New $xml_our_price_4</FONT>
    ];
  }
